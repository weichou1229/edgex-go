...
// RemoveDeviceInfoByDeviceName provides a mock function with given fields: deviceName
func (_m *DBClient) RemoveDeviceInfoByDeviceName(deviceName string) errors.EdgeX {
	ret := _m.Called(deviceName)

	if len(ret) == 0 {
		panic("no return value specified for RemoveDeviceInfoByDeviceName")
	}
